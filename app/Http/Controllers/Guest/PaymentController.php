...
class PaymentController extends Controller
{
    ...
    public function payment() {
        ...
        \Midtrans\Config::$serverKey = config('midtrans.server_key');
            ...
            $payment = DB::table('documents')->where('idOrder', $idOrder)->select('documents.idOrder','documents.file', 'documents.amount')->get();
                return view('guest.payment', compact('payment', 'idOrder', 'snapToken', 'totalAmount'));
    }

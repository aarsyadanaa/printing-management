...
class UploadController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('files')) {
            ...
            return redirect('/guest/documents')->with('success', 'Dokumen berhasil diunggah.');
        } else {
            return redirect('/guest/documents')->with('error', 'Tidak ada dokumen yang diunggah.');
        }
    }
    ...
    // Periksa apakah file perlu diolah berdasarkan kondisi tertentu
        if ($this->setFileName !== null && $this->setPage !== null) {
            ...
            foreach ($pages as $pageNumber) {
                ...
                return redirect('/guest/documents');
            }
    ...
    return view('guest.documents', compact('docs', 'totalPages', 'fileData'));
    }
    ...
    //dd($name);
    $emailTujuan = "fill your email here";

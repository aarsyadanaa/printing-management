...
@section('content')
    <div class="container">
        <div class="jumbotron">
            ...
            @endif
            <br><br><br>
            <h1 class="display-6">Data Semua Transaksi</h1>
            <hr class="my-4">
            <table class="table">
                ...
                <tbody>
                    @foreach ($document as $num => $data)
                        <tr>
                            ...
                            <button type="button" class="btn btn-danger preview-btn" data-toggle="modal" data-target="#exampleModal{{$num + 1}}">Lihat</button>
                            </td>
                            <td>
                                <form method="post" action="{{ url('admin/transaksi/'.$data->id) }}"> 
                                    @csrf 
                                    {{ method_field('delete') }} 

...
<body>
    ...
    <form action="/guest/totalPage" method="post"> 
        @csrf 
        ...
        <?php $name = $data['fileName']; ?>
            ...
            <button class="open-modal-button" type="button" data-total-pages="{{ $data['totalPages'] }}" 
            data-name="{{ $data['fileName'] }}">Print Setting</button>
        </div>
        @endforeach
    ...
    <div class="modal-content">
        ...
        <form id="printSettingsForm" action="/guest/printOption" method="post">
            @csrf
            <label for="pageCount">Page:</label>
            <input type="text" id="pageCount" name="setPage" min="1" placeholder="eg. 1-2, 3,">
            <br><br>
            <label for="copyCount">Copy:</label>
            <input type="number" id="copyCount" name="copyCount" min="1" placeholder="eg. 3">
            <br><br>
